...
import edu.school21.sockets.app.TanksApplication;
...
public class Bullet {
    private final Image imageUp = new Image(Objects.requireNonNull(TanksApplication.class.getResourceAsStream("/Bullet.png")), Field.BULLET_WIDTH, Field.BULLET_HEIGHT, false, false);
    private final Image imageDown = new Image(Objects.requireNonNull(TanksApplication.class.getResourceAsStream("/BulletEnemy.png")), Field.BULLET_WIDTH, Field.BULLET_HEIGHT, false, false);
    private final int x;
    private int y;
